...
export default function OnProgressTasks({ tasks, projectId }) {
    ...
    return (
        <div className="w-full p-5 rounded-lg border border-neutral-200 bg-white shadow-xs">
            <div className="w-full flex items-center justify-between">
                <div className="px-4 py-2 rounded-md bg-amber-200/75 text-xs flex items-center justify-center gap-1 cursor-pointer">
                    <RiProgress4Line size={18} className="text-yellow-600" />
                    <span className="text-yellow-600">OnProgress</span>
                </div>
                <div>
            ...
            <div className="mt-5 w-full">
                                ...
                                <DropdownMenuContent className={`space-y-2`}>
                                    <DropdownMenuItem>
                                        <div onClick={(e) => handleUpdateStatus(e,task._id)} className="flex items-center justify-center gap-2">
                                            ...
                                            <span className='text-green-500 text-xs'>Mark as Completed</span>
                                        </div>
                                    </DropdownMenuItem>
                ...
                <span className="text-xs mt-5">No On Progress Tasks</span>
                </div>}
            </div>
        </div>
    )
